	...
	<table class="table table-hover">
		...
		<c:forEach items="${requestScope.issues }" var="issues">
			<tr>
				...
				<!-- <td><input type="button" class="btn btn-link" onclick="edit()" value="Edit"></input></td>
				<td><input type="button" class="btn btn-link" onclick="myFunction()" value="Delete"></input></td> - -->
			</tr>
