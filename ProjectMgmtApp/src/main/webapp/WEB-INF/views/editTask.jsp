...
<div class="info">
	...
	<form:form commandName="task" method="post">
		<select name="completetionLevel">
					...
					<input type="hidden" value="${requestScope.workQueueID }"/>
					<button type="submit" class="class="btn btn-large btn-inverse">Submit Change</button>
	</form:form>
	<table>
