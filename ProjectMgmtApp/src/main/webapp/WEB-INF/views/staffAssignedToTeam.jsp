...
<div class="info">
	...
	<!-- logged in user -->
	<br/><br/>
	<h3>Staff has already been assigned to team</h3>
	<h3><a href="${pageContext.servletContext.contextPath}/companyadmin/addStaff.htm">Click Here</a> to add another Staff</h3>
</div>
</center>
</body>
</html>