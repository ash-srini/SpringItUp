...
<div class="info">
	...
	<!-- logged in user -->
	<br/><br/>
	Project ahs be successfully added!</br>
	<a href="${pageContext.servletContext.contextPath}/manager/manageProject.htm">Click Here</a>to go abck to project management
</div>
</center>
</body>
</html>