...
<div class="info">
	...
	<!-- logged in user -->
	<br/><br/>
	<form action="setProjectStage.htm" method="post">
	<!--  drop down to select team stage from list of teams in the project-->
	<h4>SELECT Sage:</h4> </br>
	<select name="stage" multiple="multiple">
			<c:forEach items="${requestScope.projectTeams }" var="projectTeams">
			<option value="${projectTeams.teamName}">${projectTeams.teamName }</option>
			</c:forEach>
			</select></br>
			</br>
			<button type="submit" class="btn btn-large btn-inverse">Add Project</button>
	</form>
</div>
</center>
</body>
