...
<center>
<div class="info">
	<form action="editIssue.htm" method="post"> 
	<!-- company name -->
	<br/><br/>
	<!-- logged in user -->
	<br/><br/>
	...
	<tr>
			...
			<td> <c:out value=" ${requestScope.description }"> </c:out> </td>
		</tr>
		<tr>
			<td>Description :</td>
			<td> <input type="text" value="${requestScope.description }" name="description"/></td>
		</tr>
	...
	<input type="hidden" value="${requestScope.workQueueID }" name="workQueueID">
	<button type="submit" class="btn btn-large btn-inverse">Submit Changes</button>
	</form>
</div>
</center>
</body>
