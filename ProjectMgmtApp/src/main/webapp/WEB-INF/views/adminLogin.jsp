...
<div class="info">
	...
	<div style="padding: 40px;">
		<table>
			<thead></thead>
			<tr><h3><a href ="${pageContext.servletContext.contextPath}/companyadmin/showAddUser.htm"> Add User</a></h3></tr>
			<tr><h3><a href ="${pageContext.servletContext.contextPath}/companyadmin/createTeam.htm"> Add Team </a></h3></tr>
			<tr><h3><a href ="${pageContext.servletContext.contextPath}/companyadmin/addStaff.htm"> Add Staff To Team </a></h3></tr>
		</table>
	</div>
</div>
</center>
