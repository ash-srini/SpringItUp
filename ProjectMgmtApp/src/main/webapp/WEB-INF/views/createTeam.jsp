...
<br/><br/><br/><br/>
			...
			<div class="team">
				<h3>Add Teams to Company</h3>
				<form:form commandName="team" method="POST">
				<h5>Team Name:</h5></br>
				<form:input path="teamName"></form:input>
					<%-- <form:select path="teamName">
						<form:option value="Engineering"></form:option>
						<form:option value="Testing"></form:option>
						<form:option value="Quality Assurance"></form:option>
						<form:option value="Customer Support"></form:option>
						<form:option value="User Interface"></form:option>
						<form:option value="Account Management"></form:option>
						<form:option value="Marketing"></form:option>
						<form:option value="Sales"></form:option>
						<form:option value="Human Resources"></form:option>
					</form:select> --%>
					</br></br>
					<button type="submit" class="btn btn-large btn-inverse " id="loadStaff">Create Team </button>
				</form:form>
