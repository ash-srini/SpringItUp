...
<div class="info">
	...
	<ul>
		...
		<li> <a href="${pageContext.servletContext.contextPath}/employee/myTask.htm">My Tasks</a> </li><br/><br/>
		<li> <a href="${pageContext.servletContext.contextPath}/employee/myIssue.htm">My Issues</a> </li>
	</ul>
	...
	<h3> Assigned Team: ${sessionScope.stafflogin.team.teamName } </h3>
		<h4>  Team Project: ${sessionScope.stafflogin.team.project.projectName } </h4>
	</div>
